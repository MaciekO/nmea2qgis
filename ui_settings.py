...
#
# Created: Sun Sep 15 19:03:53 2013
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.hdopCheck.sizePolicy().hasHeightForWidth())
        self.hdopCheck.setSizePolicy(sizePolicy)
        self.hdopCheck.setObjectName(_fromUtf8("hdopCheck"))
        self.gridLayout_2.addWidget(self.hdopCheck, 0, 1, 1, 1)
        ...
        self.nullBox = QtGui.QSpinBox(Dialog)
        self.nullBox.setObjectName(_fromUtf8("nullBox"))
        self.horizontalLayout_2.addWidget(self.nullBox)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.hdopCheck.setText(_translate("Dialog", "pdop", None))
        ...
        self.datastatusCheck.setText(_translate("Dialog", "data status", None))
        ...
        self.label.setText(_translate("Dialog", "null value:", None))
